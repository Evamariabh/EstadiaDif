        ...
        if ($isDBConnected) {
            try {
                ...
                "SELECT 
                    ...
                    s.Telefono, 
                    s.Observaciones 
                FROM solicitudes_servicios s INNER JOIN servicios x ON x.IDServicio = s.LINK_Servicio  WHERE `CodigoTraslado` = :codigo";
                ...
                if ($STMT->rowCount() > 0) {
                    ...
                    $Response = BuildResponse(200, 'Cita no encontrada');
                }
            } catch (\Throwable $th) {
